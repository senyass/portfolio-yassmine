function ResourceCard({ title, image, link, className = "" }) {
    return (
        <a href={link} className={`mx-auto relative block w-[300px] min-[500px]:w-[360px] bg-yellow p-5 pt-10 shadow-xl hover:-translate-y-2 transition-all duration-300 ${className}`}>
